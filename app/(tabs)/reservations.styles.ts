...
export const reservationsStyles = StyleSheet.create({
  ...
  // Compact Quick Actions (for completed reservations)
  quickActions: {
    flexDirection: 'row',
    marginBottom: 8,
    gap: 6,
  ...
  // Stats section for when there are reservations
  statsSection: {
    marginBottom: 24,
  },
  statsContainer: {
  ...
  // Enhanced reservation status indicators
  statusDot: {
    width: 12,
    height: 12,
    borderRadius: 6,
  ...
  // Filter chips (if we want to add filtering)
  filterSection: {
    marginBottom: 20,
  },
  filterScrollView: {
